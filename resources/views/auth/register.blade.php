                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <!-- <input id="departamento" type="departamento" class="form-control{{ $errors->has('departamento') ? ' is-invalid' : '' }}" name="departamento"> -->

                                <select id="departamento" type="departamento" class="custom-select form-control{{ $errors->has('departamento') ? ' is-invalid' : '' }}" name="departamento">
